    ...
    <section className="hero">
      <div className="heroText">
        ...
        <p className="heroDescription">
          ...
          someone who likes making things, breaking them on purpose, and
          polishing the details until the final result actually does what it's
          meant to.
        </p>
      ...
      <div className="heroBear" aria-hidden="true">
        <svg
          viewBox="0 0 300 300"
